...
class Critic(tf.keras.Model):
    def __init__(self, name, hidden_0=CRITIC_HIDDEN_0, hidden_1=CRITIC_HIDDEN_1,hidden_2=CRITIC_HIDDEN_2,):
...
class Actor(tf.keras.Model):
    def __init__(self, name, actions_dim, hidden_0=ACTOR_HIDDEN_0, hidden_1=ACTOR_HIDDEN_1,hidden_2=ACTOR_HIDDEN_2):
        ...
        self.dense_1 = Dense(self.hidden_1, activation='relu')
        self.dense_2 = Dense(self.hidden_2, activation='relu')
        self.policy = Dense(self.actions_dim) # we want something beetween zero and one
